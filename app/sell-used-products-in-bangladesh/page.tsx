...
const questions = [
  ...
  { question: "Can buyers ask for a product I have?", answer: "Yes. Buyers can post a request describing the product they want and their budget. If you see a request for something you have, tap \"I have this\" to message the buyer and arrange the deal the same way as any listing." },
